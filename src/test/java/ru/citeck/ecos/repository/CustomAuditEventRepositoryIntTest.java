package ru.citeck.ecos.repository;

import ru.citeck.ecos.GatewayApp;
import ru.citeck.ecos.config.Constants;
import ru.citeck.ecos.config.audit.AuditEventConverter;
import ru.citeck.ecos.domain.PersistentAuditEvent;
...
import static ru.citeck.ecos.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
